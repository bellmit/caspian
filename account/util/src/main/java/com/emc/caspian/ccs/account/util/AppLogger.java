...
package com.emc.caspian.ccs.account.util;
 ...
 * specific logger implementation and hides it from application classes. Created by gulavb on 3/3/2015.
 */
public class AppLogger {

  public static void setLoggerConfigPath(String loggerConfigPath) {
    if (!loggerConfigPath.isEmpty()) {
