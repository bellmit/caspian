...
public class Authentication implements Serializable {
  ...
  public static final class Identity {
    ...
    public static final Identity password(String domainName, String username, String password) {
      ...
      identity.getMethods().add("password");
      Password method = new Password();
      com.emc.caspian.ccs.keystone.model.Authentication.Identity.Password.User.Domain domain =
          new com.emc.caspian.ccs.keystone.model.Authentication.Identity.Password.User.Domain();
  ...
  public static final class Scope {
    ...
    public static Scope project(String domainName, String projectName) {
      Scope scope = new Scope();
      com.emc.caspian.ccs.keystone.model.Authentication.Scope.Project.Domain domain =
          new com.emc.caspian.ccs.keystone.model.Authentication.Scope.Project.Domain();
      domain.setName(domainName);
      Project project = new Project();
    ...
    public static Scope domain(String id) {
      Scope scope = new Scope();
